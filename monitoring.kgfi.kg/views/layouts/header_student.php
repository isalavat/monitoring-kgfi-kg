...
<html lang="ru">
  ...
  <body>
    ...
    <div class="container background_" >
        <div class="row" group-id="<?php echo $groupId?>">
            <div class="col-md-2 col-md-offset-1 block-fade" >
                <h4> <a id="new-event"  class = "cursor_ "><i class="fa fa-users" aria-hidden="true">&nbsp;Neue Erreigniss</i></a></h4>
                <hr>
                <h4><a id="events"  class = "cursor_"><i class="fa fa-user" aria-hidden="true">&nbsp;&nbsp;&nbsp;Erreignise</i></a></h4>
