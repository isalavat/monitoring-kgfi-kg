	...
	<div class="container" style="margin-top: 100px;">
        <div class="row">
            ...
            <div class="col-sm-4 col-sm-offset-4 padding-right" style="box-shadow: 0px 3px 30px #bbb;">
                ...
                <?php endif?>
                <?php if (!$success):?>
                    <h5 class="text-center text-info">Добавление предмета</h5>
                    <hr>
                    <form action="" method="post" >
			
                        <div class="form-group">
                            <input type="text" name="name" class="form-control" placeholder="Название предмета" value="<?php echo $name;?>">
                        </div>
                        <div class="form-group">
                        <input type="text" name="description" class="form-control" placeholder="описание" value="<?php echo $description;?>">
                        </div>
