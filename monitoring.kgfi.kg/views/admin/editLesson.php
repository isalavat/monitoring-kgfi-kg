        ...
        <div class="row">
            ...
            <div class="col-sm-4 col-sm-offset-4 padding-right" style="box-shadow: 0px 3px 30px #bbb;">
                ...
                <?php if (!$success):?>
                    ...
                    <h5 class="text-center text-warning">Изменение предмета</h5>
                    <hr>
                    <form action="" method="post" >
			
                        <div class="form-group">
                            <input type="text" name="name" class="form-control" placeholder="Название группы" value="<?php echo $lesson['name'];?>">
                        </div>
                        <div class="form-group">
                        <input type="text" name="description" class="form-control " placeholder="описание" value="<?php echo $lesson['description'];?>">
                        </div>
