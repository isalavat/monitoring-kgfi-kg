	...
	<div class="container" style="margin-top: 100px;">
        <div class="row ">
            ...
            <div class=" col-sm-4 col-sm-offset-4 padding-right " style="box-shadow: 0px 3px 30px #bbb;">
                ...
                <?php endif?>
                <?php if (!$success):?>
                    <h5 class="text-center text-info">Выбрать расписание</h5>
                    <hr>
                    <form action="" method="post" >
			
                        <div class="form-group">    
                            <select name ="lessons-group" class="form-control" >
                                <?php foreach ($lessonsGroups as $lessonGroup) :?>
                                    <option value="<?php echo $lessonGroup['id'] ?>"><?php echo $lessonGroup['name'] ?></option>
                                <?php endforeach;?>
                            </select>    
                        </div>
