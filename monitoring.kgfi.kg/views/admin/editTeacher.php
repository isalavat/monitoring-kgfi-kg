        ...
        <div class="row">
            ...
            <div class="col-sm-4 col-sm-offset-4 padding-right" style="box-shadow: 0px 3px 30px #bbb;">
                ...
                <?php if (!$success):?>
                    ...
                    <h5 class="text-center text-warning">Изменение данных преподавателя</h5>
                    <hr>
                    <form action="" method="post" >
			
                        <div class="form-group">
                            <input type="text" name="name" class="form-control" placeholder="Название группы" value="<?php echo $teacher['name'];?>">
                        </div>
                        <hr>    
