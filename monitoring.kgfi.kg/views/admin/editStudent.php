        ...
        <div class="row">
            ...
            <div class="col-sm-4 col-sm-offset-4 padding-right" style="box-shadow: 0px 3px 30px #bbb;">
                ...
                <?php if (!$success):?>
                    ...
                    <h5 class="text-center text-warning">Изменение данных студента</h5>
                    <hr>
                    <form action="" method="post" >
			
                        <div class="form-group">
                            <input type="text" name="name" class="form-control" placeholder="Название группы" value="<?php echo $student['name'];?>">
                        </div>
                        <div class="form-group">
                            <select name="group" class="form-control">
                                <?php foreach($groups as $group):?>
                                    <option value="<?php echo $group['id'] ?>" <?php if ($student['group_id'] == $group['id']){echo 'selected';} ?> ><?php echo $group['name']?></option>
                                <?php endforeach;?>
                            </select>
                        </div>
